...
public class InteractionController {
    ...
    @PutMapping(path = "acceptProjectAndUpdateUser/projectId/{projectId}/userId/{userId}")
    public ResponseEntity<Void> acceptProjectAndUpdateUser(@PathVariable(name="projectId") Long projectId, @PathVariable(name="userId") Long userId){
        try{
